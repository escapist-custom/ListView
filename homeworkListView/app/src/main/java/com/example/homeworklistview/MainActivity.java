...
import com.example.homeworklistview.adapters.PersonAdapter;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PersonAdapter adapter = new PersonAdapter(this, makeBigMan());
    ...
    Person[] makeBigMan() {
        ...
        for (int i = 0; i < flags.length; i++) {
            Person person = new Person(names[i], money[i], flags[i]);
            people[i] = person;
        }
        return people;
    }
